...
import DistSystComm.MessagePasser.RequestState;
    ...
    public static void main(String[] args) {
        ...
        while(true) {
            try {
                ...
                System.out.println("");
                System.out.println("What would you like to do? (send.receive.multicast.request.release.status.withdraw)");
                ...
                // 'send' - send a message to someone
                    ...
                    // get the rest of the message information
                        ...
                        while(!validKind) {
                            ...
                            if(kind.equalsIgnoreCase("critical section request")) {
                    ...
                    // get the rest of the message information
                        ...
                        String kind = "";
                        while(!validKind) {
                            System.out.println("Great! What type of message would you like to send to " + groupDestination + "?");
                            kind = userInput.readLine();   
                            if(kind.equalsIgnoreCase("critical section request") || 
                                    kind.equalsIgnoreCase("critical section release") ||
                                    kind.equalsIgnoreCase("critical section reply")) {
                                System.out.println("We're sorry. That message type is reserved and cannot be used in this context.");
                                validKind = false;
                            } else {
                                validKind = true;
                ...
                else if(request.equalsIgnoreCase("request") || request.equalsIgnoreCase("ca")) {
                    System.out.println("Request for critical section sent.");
                    mp.requestCriticalSection();
                }
                else if(request.equalsIgnoreCase("release") || request.equalsIgnoreCase("cr")) {
                    System.out.println("Critical section has been released.");
                    mp.releaseCriticalSection();
                }
